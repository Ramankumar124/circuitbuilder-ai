const LandingPage = () => {
  return (
    <>
      ...
      <div>
      <nav id="header" className="fixed w-full z-50 bg-neutral-900 bg-opacity-90 backdrop-blur-md">
    <div className="container mx-auto px-4 py-3 flex justify-between items-center">
      <div className="flex items-center">
        <a href="#hero" className="text-white font-bold text-xl">
          <span className="text-[#6E56CF]">Circuit</span>Builder<span className="text-[#6E56CF]">AI</span>
        </a>
      </div>

      {/* <!-- Desktop Menu --> */}
      <ul className="hidden md:flex space-x-6">
        <li><a href="#hero" className="text-white hover:text-[#6E56CF] transition-colors duration-300">Home</a></li>
        <li><a href="#features" className="text-white hover:text-[#6E56CF] transition-colors duration-300">Features</a></li>
        <li><a href="#templates" className="text-white hover:text-[#6E56CF] transition-colors duration-300">Templates</a></li>
        <li><a href="#editor" className="text-white hover:text-[#6E56CF] transition-colors duration-300">Editor</a></li>
        
      </ul>

      {/* <!-- Mobile Menu Button --> */}
      <button id="mobile-menu-button" className="md:hidden flex items-center" aria-label="Open navigation menu">
    ...
    {/* <!-- Mobile Menu --> */}
    <div id="mobile-menu" className="hidden md:hidden bg-neutral-800 animate__animated animate__fadeIn">
      <ul className="py-4 px-4 space-y-3">
        <li><a href="#hero" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Home</a></li>
        <li><a href="#features" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Features</a></li>
        <li><a href="#editor" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Editor</a></li>
        <li><a href="#tools" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Tools</a></li>
        <li><a href="#templates" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Templates</a></li>
        <li><a href="#pricing" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Pricing</a></li>
        <li><a href="#faq" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">FAQ</a></li>
        <li><a href="#contact" className="block text-white hover:text-[#6E56CF] transition-colors duration-300 py-2">Contact</a></li>
      </ul>
    </div>
  </nav>
        <section
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-16 animate__animated animate__fadeIn">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Intuitive <span className="text-[#6E56CF]">Circuit Editor</span></h2>
        <p className="text-neutral-300 max-w-3xl mx-auto">Experience our powerful AI-driven circuit design environment with intuitive controls, real-time simulation, and intelligent component suggestions.</p>
      </div>
      ...
      <div className="bg-[#242424] rounded-xl overflow-hidden shadow-2xl border border-neutral-800 animate__animated animate__fadeInUp">
        ...
        <div className="bg-neutral-800 border-b border-neutral-700 p-3 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="relative">
              <button id="export-btn" className="bg-[#6E56CF] hover:bg-[#7d66dc] text-white rounded-lg px-4 py-2 flex items-center transition-all duration-200 hover:shadow-lg hover:shadow-[#6E56CF]/40">
                <span>Export</span>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                </svg>
              </button>
              <div id="export-dropdown" className="hidden absolute right-0 mt-2 w-48 bg-neutral-800 rounded-lg shadow-lg border border-neutral-700 z-10">
                <ul className="py-2">
                  <li><a href="#" className="block px-4 py-2 text-white hover:bg-neutral-700 transition-colors">PNG Image</a></li>
                  <li><a href="#" className="block px-4 py-2 text-white hover:bg-neutral-700 transition-colors">PDF Document</a></li>
                  <li><a href="#" className="block px-4 py-2 text-white hover:bg-neutral-700 transition-colors">Gerber Files</a></li>
                  <li><a href="#" className="block px-4 py-2 text-white hover:bg-neutral-700 transition-colors">SPICE Model</a></li>
                  <li><a href="#" className="block px-4 py-2 text-white hover:bg-neutral-700 transition-colors">BOM Export</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="flex h-[600px]">
          ...
          <div className="flex-1 bg-[#242424] relative overflow-hidden">
            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute top-[100px] left-[200px] bg-neutral-800 rounded-md p-2 shadow-md border border-neutral-700 cursor-move">
                <div className="text-center text-xs text-white mb-1">ATmega328P</div>
              ...
              <div className="absolute top-[200px] left-[400px] bg-neutral-800 rounded-md p-2 shadow-md border border-neutral-700 cursor-move">
                <div className="text-center text-xs text-white mb-1">10kΩ</div>
              ...
              <div className="absolute top-[350px] left-[300px] bg-neutral-800 rounded-md p-2 shadow-md border border-neutral-700 cursor-move">
                <div className="text-center text-xs text-white mb-1">220uF</div>
              ...
              <svg className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <path d="M245 125 L 320 125 L 320 205 L 400 205" stroke="#6E56CF" stroke-width="2" fill="none"></path>
                <path d="M245 145 L 280 145 L 280 350 L 300 350" stroke="#6E56CF" stroke-width="2" fill="none"></path>
              </svg>
              
              {/* <!-- Measurement cursor --> */}
              <div className="absolute top-[180px] left-[350px] w-6 h-6 bg-red-500 rounded-full border-2 border-white flex items-center justify-center text-white text-xs">V</div>
            </div>
            
            {/* <!-- Floating Action Button --> */}
            <div className="absolute bottom-6 right-6">
              <button id="share-fab" className="w-14 h-14 rounded-full bg-[#6E56CF] hover:bg-[#7d66dc] text-white shadow-lg flex items-center justify-center transition-all duration-300 hover:shadow-xl hover:shadow-[#6E56CF]/30 hover:scale-110">
          ...
          <div className="w-64 bg-neutral-800 border-l border-neutral-700 p-4 overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Component Type</label>
                <div className="bg-neutral-700 rounded-lg p-2 text-white text-sm">ATmega328P</div>
              </div>
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Manufacturer</label>
              ...
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Package</label>
                <select className="w-full bg-neutral-700 border border-[#505050] rounded-lg p-2 text-white text-sm focus:border-[#6E56CF] outline-none">
              ...
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Clock Speed</label>
                <input type="text" value="16 MHz" className="w-full bg-neutral-700 border border-[#505050] rounded-lg p-2 text-white text-sm focus:border-[#6E56CF] outline-none"/>
              </div>
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Operating Voltage</label>
                <input type="text" value="5V" className="w-full bg-neutral-700 border border-[#505050] rounded-lg p-2 text-white text-sm focus:border-[#6E56CF] outline-none"/>
              </div>
              <div>
                <label className="block text-neutral-400 text-sm mb-2">Description</label>
                <textarea className="w-full bg-neutral-700 border border-[#505050] rounded-lg p-2 text-white text-sm focus:border-[#6E56CF] outline-none h-20 resize-none">8-bit microcontroller with 32KB flash memory, 2KB SRAM, and 1KB EEPROM.</textarea>
              </div>
              <div className="pt-2">
                <h4 className="text-neutral-400 text-sm mb-3">AI Suggestions</h4>
                <div className="space-y-2">
                  <div className="bg-neutral-700 hover:bg-neutral-600 rounded-lg p-2 cursor-pointer border border-[#505050] group hover:border-[#6E56CF] transition-all">
                    <div className="flex items-center">
                      <div className="w-6 h-6 rounded-full bg-[#6E56CF]/20 flex items-center justify-center mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#6E56CF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                        </svg>
                      </div>
                      <span className="text-white text-xs">Add decoupling capacitor</span>
                    </div>
                  </div>
                  <div className="bg-neutral-700 hover:bg-neutral-600 rounded-lg p-2 cursor-pointer border border-[#505050] group hover:border-[#6E56CF] transition-all">
                    <div className="flex items-center">
                      ...
                      <span className="text-white text-xs">Add crystal oscillator</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-neutral-800 border-t border-neutral-700 p-2 flex justify-between items-center text-xs text-neutral-400">
          <div className="flex items-center">
            <span className="px-2 py-1 rounded bg-[#6E56CF]/20 text-[#6E56CF] mr-2">Ready</span>
